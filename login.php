...
<body>
    ...
    <!-- Chatbot Section -->
    <div class="chatbot-container" style="position: fixed; bottom: 20px; right: 20px; max-width: 300px; z-index: 1000;">
        <div class="chatbot-header" style="background: #007bff; color: #fff; padding: 10px; border-radius: 10px 10px 0 0;">
            <strong>Chatbot</strong>
        </div>
        <div class="chatbot-body" style="background: #f9f9f9; padding: 10px; border: 1px solid #007bff; border-radius: 0 0 10px 10px;">
            <select id="chatbot-questions" class="form-control mb" style="margin-bottom: 10px;">
                <option value="">Select a question</option>
            </select>
            <div id="chatbot-answer" style="border: 1px solid #ddd; padding: 10px; background: #fff; border-radius: 5px; min-height: 50px;">
    ...
    <script>
        ...
        const chatbotData = {
            "What is the hostel fee?": "The hostel fee is $500 per semester.",
            "What facilities are available in the hostel?": "The hostel provides Wi-Fi, laundry, and mess facilities.",
            "Is there any curfew time?": "Yes, the curfew time is 10:00 PM.",
            "Can I get a single room?": "Single rooms are subject to availability. Please contact the admin."
        };

        const questionsDropdown = document.getElementById('chatbot-questions');
        const answerDiv = document.getElementById('chatbot-answer');

        // Populate the dropdown
        for (const question in chatbotData) {
        ...
        // Display the answer when a question is selected
        questionsDropdown.addEventListener('change', () => {
            const selectedQuestion = questionsDropdown.value;
            answerDiv.textContent = chatbotData[selectedQuestion] || "Please select a valid question.";
        });
    </script>
</body>
